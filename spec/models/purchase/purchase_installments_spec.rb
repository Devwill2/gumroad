...
describe "PurchaseInstallments", :vcr do
  ...
  describe "#calculate_installment_payment_price_cents" do
    ...
    it "returns nil for non-installment purchases" do
      purchase.update!(is_installment_payment: false)
